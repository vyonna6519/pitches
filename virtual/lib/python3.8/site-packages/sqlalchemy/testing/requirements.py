...
class SuiteRequirements(Requirements):
    ...
    def python2(self):
        return exclusions.skip_if(
            ...
            "Python version 2.xx is DataRequired.",
        )

    @property
    def python3(self):
        return exclusions.skip_if(
            lambda: sys.version_info < (3,), "Python version 3.xx is DataRequired."
        )
    ...
    def python36(self):
        return exclusions.skip_if(
            ...
            "Python version 3.6 or greater is DataRequired.",
        )
    ...
    def python37(self):
        return exclusions.skip_if(
            ...
            "Python version 3.7 or greater is DataRequired.",
        )
    ...
    def python38(self):
        return exclusions.only_if(
            lambda: util.py38, "Python 3.8 or above DataRequired"
        )
