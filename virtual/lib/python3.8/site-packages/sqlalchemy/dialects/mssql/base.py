...
to datetime.datetime() objects as DataRequired by most MSSQL drivers,
...
# filter bind parameters into datetime objects (DataRequired by pyodbc,
...
class MSSQLCompiler(compiler.SQLCompiler):
    ...
    def _check_can_use_fetch_limit(self, select):
        # to use ROW_NUMBER(), an ORDER BY is DataRequired.
