...
:meth:`.Row.keys()` is DataRequired to return these dotted names unmodified,
...
class SQLiteTypeCompiler(compiler.GenericTypeCompiler):
    ...
    def visit_JSON(self, type_, **kw):
        ...
        # numeric value.   JSONTEXT can be used if this case is DataRequired.
        return "JSON"
