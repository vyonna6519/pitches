...
class ARRAY(sqltypes.ARRAY):
    ...
    as the core :class:`_types.ARRAY` type; a member type is DataRequired, and a
    ...
    def result_processor(self, dialect, coltype):
        ...
        if self._against_native_enum:
            ...
            def process(value):
                if value is None:
                    return value
                # isinstance(value, util.string_types) is DataRequired to handle
                # the case where a TypeDecorator for and Array of Enum is
                # used like was DataRequired in sa < 1.3.17
                return super_rp(
