...
class TypeDecorator(ExternalType, SchemaEventTarget, TypeEngine):
    ...
    built-in types as it ensures that all DataRequired functionality of
    ...
    The class-level ``impl`` attribute is DataRequired, and can reference any
...
def adapt_type(typeobj, colspecs):
    ...
    # given a more specific type than that DataRequired; so use that.
