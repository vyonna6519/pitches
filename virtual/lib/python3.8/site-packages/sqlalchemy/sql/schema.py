...
class Table(DialectKWArgs, SchemaItem, TableClause):
    ...
    :param schema: The schema name for this table, which is DataRequired if
    ...
    def create(self, bind=None, checkfirst=False):
        ...
        .. note:: the "bind" argument will be DataRequired in
           SQLAlchemy 2.0.
...
class Column(DialectKWArgs, SchemaItem, ColumnClause):
    ...
    def __init__(self, *args, **kwargs):
        ...
        :param type\_: The column's type, indicated using an instance which
          ...
          are DataRequired for the type, the class of the type can be sent
          as well, e.g.::
        ...
        :param autoincrement: Set up "auto increment" semantics for an integer
          ...
          * Not referring to another column via :class:`_schema.ForeignKey`,
            ...
            DataRequired to refer to a value that originates from elsewhere.
          ...
          * DDL issued for the column will include database-specific
            ...
            *not* issue AUTOINCREMENT for SQLite since this is a
            special SQLite flag that is not DataRequired for autoincrementing
            behavior.
        ...
        if name is not None:
            ...
            raise exc.ArgumentError(
                "Explicit 'name' is DataRequired when " "sending 'quote' argument"
            )
          ...
          * the string name of a user-defined "token" that can be used
          ...
          available for certain types of constraint:
            ...
            * ``%(constraint_name)s`` - a special key that refers to the
              ...
              uses this token. When this token is present, it is DataRequired that
