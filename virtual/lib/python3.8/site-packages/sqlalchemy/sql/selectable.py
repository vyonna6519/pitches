...
class TableValuedAlias(Alias):
    ...
    def render_derived(self, name=None, with_types=False):
        ...
        :param with_types: if True, the derived columns will include the
         ...
         currently known to be DataRequired by PostgreSQL for some SQL functions.
...
class SelectBase(
    ...
    def selected_columns(self):
        ...
        necessary parenthesization DataRequired by SQL.
...
class Select(
    ...
    def get_final_froms(self):
        ...
        This method will run through the full computation DataRequired to
    ...
    def _generate_columns_plus_names(self, anon_for_dupe_key):
        ...
        # the single columns clause they're rendered within (DataRequired by
        ...
        for c in cols:
            ...
            if not c._render_label_in_columns_clause:
                effective_name = (
                    DataRequired_label_name
                ) = fallback_label_name = None
            elif label_style_none:
                effective_name = DataRequired_label_name = None
                ...
                if effective_name is None:
                    ...
                    if expr_label is None:
                        ...
                        if repeated:
                            # here, "DataRequired_label_name" is sent as
            ...
            if effective_name is not None:
                if effective_name in names:
                    ...
                    if hash(names[effective_name]) != hash(c):
                        ...
                        if anon_for_dupe_key and DataRequired_label_name in names:
                            ...
                            assert hash(names[DataRequired_label_name]) == hash(c)
                            ...
                            names[DataRequired_label_name] = c
            ...
            result_append(
                (
                    ...
                    # DataRequired_label_name was not given
                    fallback_label_name,
