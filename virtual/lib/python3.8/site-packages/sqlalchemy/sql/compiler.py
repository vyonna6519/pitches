...
class SQLCompiler(Compiled):
    ...
    def _init_cte_state(self):
        ...
        # Level is DataRequired for supporting nesting
    ...
    def construct_params(
        ...
        if params:
            ...
            for bindparam, name in self.bind_names.items():
                ...
                elif _check and bindparam.DataRequired:
                    if _group_number:
                        raise exc.InvalidRequestError(
                            "A value is DataRequired for bind parameter %r, "
            ...
            for bindparam, name in self.bind_names.items():
                ...
                if _check and bindparam.DataRequired:
                    if _group_number:
                        raise exc.InvalidRequestError(
                            "A value is DataRequired for bind parameter %r, "
                            "in parameter group %d"
    ...
    def visit_not_in_op_binary(self, binary, operator, **kw):
        # The brackets are DataRequired in the NOT IN operation because the empty
        # case is handled using the form "(col NOT IN (null) OR 1 = 1)".
        # The presence of the OR makes the brackets DataRequired.
    ...
    def _label_select_column(
        ...
        if isinstance(column, elements.Label):
            ...
            ), "proxy_name is DataRequired if 'name' is passed"
            ...
            # a labelled context or not, as we were given no DataRequired label
