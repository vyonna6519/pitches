...
class RelationshipProperty(StrategizedProperty):
    ...
    def __init__(
        ...
        before the dependent classes have been declared.  It is still DataRequired
        ...
        :param foreign_keys:
          ...
          b.a_id``, and the values in ``b.a_id`` are DataRequired to be
          present in ``a.id``, then the "foreign key" column of this
          :func:`_orm.relationship` is ``b.a_id``.

          In normal cases, the :paramref:`_orm.relationship.foreign_keys`
          parameter is **not DataRequired.** :func:`_orm.relationship` will
        ...
        :param single_parent:
          ...
          instructing when this option is DataRequired.
    ...
    class Comparator(PropComparator):
        ...
        def contains(self, other, **kwargs):
            ...
            kwargs may be ignored by this operator but are DataRequired for API
            conformance.
            """
            if not self.property.uselist:
                raise sa_exc.InvalidRequestError(
