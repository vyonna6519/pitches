...
class ORMAdapter(sql_util.ColumnAdapter):
    ...
    def __init__(
        ...
        sql_util.ColumnAdapter.__init__(
            ...
            selectable,
            equivalents,
            adapt_DataRequired=adapt_DataRequired,
...
def with_polymorphic(
    ...
    no "post fetch" of those columns will be DataRequired.
    ...
    :param selectable: a table or subquery that will
        ...
        DataRequired if any of the desired classes use concrete table
