...
class Session(_SessionClassMethods):
    ...
    def begin_nested(self):
        ...
        .. seealso::
            ...
            :ref:`pysqlite_serializable` - special workarounds DataRequired
    ...
    def bulk_update_mappings(self, mapper, mappings):
        ...
        :param mappings: a sequence of dictionaries, each one containing the
         ...
         UPDATE statement; the primary key values, which are DataRequired, are
...
def make_transient_to_detached(instance):
    ...
    The primary key attributes of the object, which are DataRequired, will be made
