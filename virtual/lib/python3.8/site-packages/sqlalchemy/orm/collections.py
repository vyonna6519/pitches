...
def _instrument_class(cls):
    ...
    _assert_DataRequired_roles(cls, roles, methods)
...
def _assert_DataRequired_roles(cls, roles, methods):
...
__interfaces = {
    ...
    # decorators are DataRequired for dicts and object collections.
